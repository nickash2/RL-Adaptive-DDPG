...
class DDPG():
    def __init__(self, discount_factor: float, update_factor: float, action_space: Space, hidden_size: List[int,int], input_size: int):
    ...
    def update(self, target, source, tau):
        """
